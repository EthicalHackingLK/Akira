...
async def save_group(bot, message):
    ...
    buttons = [[
        InlineKeyboardButton('𝐉𝐨𝐢𝐧 𝐍𝐨𝐰', url=f'https://t.me/slofficialmain'),
               ],[
        InlineKeyboardButton('𝐌𝐨𝐫𝐞 𝐈𝐧𝐟𝐨', callback_data='help')
               ],[
    ...
    await bot.send_message(
        text=script.WELCOME_TXT.format(message.from_user.mention),
